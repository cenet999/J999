...
namespace NoAdmin.Blazor.Middlewares;
...
public class IpWhitelistMiddleware
{
	...
	public async Task InvokeAsync(HttpContext context)
	{
		...
		var clientIp = IpHelper.GetClientIpAddress(context, _logger);
		...
		var enabledEntries = await fsql.Select<SysIpWhitelist>()
			.Where(x => x.IsEnabled)
			.ToListAsync();
