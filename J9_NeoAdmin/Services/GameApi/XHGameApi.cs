...
public class XHGameApi {
    ...
    public XHGameApi(ILogger<XHGameApi> logger, IFreeSql fsql) {
        _logger = logger;
        _fsql = fsql;
    ...
    /// <param name="from">查询开始时间（<c>yyyy-MM-dd HH:mm:ss</c>，按 <see cref="J9_NeoAdmin.Utils.TimeHelper.BeijingTz"/> 墙上时钟解读，与官方示例 Unix 语义一致）</param>
