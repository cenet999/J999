...
namespace J9_NeoAdmin.Services.PayApi;
...
public class PayPOPOApi
{
    ...
    public PayPOPOApi(ILogger<PayPOPOApi> logger, IFreeSql fsql, TaskProgressService taskProgressService, IConfiguration configuration)
    {
        _logger = logger;
        _fsql = fsql;
