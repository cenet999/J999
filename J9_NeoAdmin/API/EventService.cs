...
public class EventService : BaseService
{
    ...
    public EventService(IFreeSql freeSql, FreeScheduler.Scheduler scheduler, ILogger<EventService> logger, IConfiguration configuration, IWebHostEnvironment webHostEnvironment, NeoAdmin.Blazor.Core.Identity.NeoAdminAuthService authService)
