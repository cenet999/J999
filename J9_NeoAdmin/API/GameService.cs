...
public class GameService : BaseService
{
    ...
    public GameService(
        IFreeSql freeSql,
        Scheduler scheduler,
        ILogger<GameService> logger, IConfiguration configuration,
        MSGameApi msGameApi,
        XHGameApi xhGameApi,
        GameIconLocalizationService gameIconLocalizationService,
        IWebHostEnvironment webHostEnvironment,
        PerMemberAsyncGate perMemberGate,
        NeoAdmin.Blazor.Core.Identity.NeoAdminAuthService authService)
