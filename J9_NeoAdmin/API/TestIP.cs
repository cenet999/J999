...
public class TestIP : BaseService
{
    public TestIP(
        IFreeSql freeSql,
        Scheduler scheduler,
        ILogger<TestIP> logger, IConfiguration configuration, IWebHostEnvironment webHostEnvironment, NeoAdmin.Blazor.Core.Identity.NeoAdminAuthService authService)
