...
using J9_NeoAdmin.Services.PayApi;
...
public class TransActionService : BaseService
{
    ...
    /// 交易服务构造
    /// </summary>
    /// <param name="freeSql">数据库服务</param>
    ...
    public TransActionService(IFreeSql freeSql, Scheduler scheduler, ILogger<TransActionService> logger, IConfiguration configuration, SessionAgent sessionAgent, TGMessageApi TGMessageApi, Pay0Api pay0Api, PayPOPOApi payPOPOApi, GameBetHistorySyncService gameBetHistorySyncService, IWebHostEnvironment webHostEnvironment, NeoAdmin.Blazor.Core.Identity.NeoAdminAuthService authService)
