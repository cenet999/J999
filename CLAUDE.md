...
- **J9_APP_102/** — React Native (Expo) cross-platform mobile app
...
- For remote phone testing, set `J9_APP_102/.env` with `EXPO_PUBLIC_API_URL=http://<server-ip>:8015` and run `pnpm dev:server`.
